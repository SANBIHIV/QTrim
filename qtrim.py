...
Analytical plotting: -plot plot_format (supports these formats:emf, jpeg, eps, pdf, png, ps, raw, rgba, svg, svgz )\n\n\
Example command:\n\
python QTrim.py -fastq myfastqfile #Runs with all default values\n\
python QTrim.py -verbose -fasta fastafile -qual qualityfile -l 10 -m 30 -o outputfilename -mode 2 -out_format 2\npython QTrim.py -fastq fastqfile -l 50 -m 30 -o outputfilename -mode 3 -out_format 3 -seq_id_stat -plot jpeg"
...
if fasta_input_check==True and fastq_input_check==True:
	...
	Verbose("Program exiting now...")
	exit(1)
elif fastq_input_check==False and fasta_input_check==False and qual_input_check==False:
	#print "No input file detected. Exiting the program now..."
	Verbose("No input file detected. Exiting the program now...")
	exit(1)
else:
	#print "File input wrong. Check command line supply of fastq or fasta or qual file. Exiting the program now..."
	Verbose("File input wrong. Check command line supply of fastq or fasta or qual file. Exiting the program now...")
	exit(1)
...
#0) Exit the program without any data cleaning\n \
